...
namespace IDs
{
    ...
    DECLARE_ID (automationWrite)
    DECLARE_ID (automationMode)
    DECLARE_ID (automationBypassed)
    DECLARE_ID (bypass)
    ...
    DECLARE_ID (AUTOMATIONCURVES)
    DECLARE_ID (AUTOMATIONCURVEMODIFIER)
    DECLARE_ID (POINT)
    ...
    DECLARE_ID (minNote)
    DECLARE_ID (maxNote)
    DECLARE_ID (minVelocity)
    DECLARE_ID (maxVelocity)
